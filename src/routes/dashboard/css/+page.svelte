<script lang="ts">
    ...
    let levels: Level[] = [
        // Beginner Levels
        { id: 1, title: 'CSS Basics', difficulty: 'beginner', isUnlocked: true },
        { id: 2, title: 'Selectors', difficulty: 'beginner', isUnlocked: false },
        // Medium Levels
        { id: 3, title: 'Flexbox', difficulty: 'medium', isUnlocked: false },
        { id: 4, title: 'Grid', difficulty: 'medium', isUnlocked: false },
        // Hard Levels
        { id: 5, title: 'Animations', difficulty: 'hard', isUnlocked: false },
        { id: 6, title: 'Advanced CSS', difficulty: 'hard', isUnlocked: false },
    ];
    ...
    function handleLevelClick(level: Level) {
        if (level.isUnlocked) {
            ...
            window.location.href = `/dashboard/quiz?id=${level.id}&category=css`;
        } else {
